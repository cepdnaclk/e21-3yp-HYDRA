...
// ULTRASONIC VERSION - Dual sensors with 10-second stability detection
...
// ─────────────────────────────────────────────────────────────────────────────
// USER DASHBOARD (Ultrasonic Version - No IR)
// ─────────────────────────────────────────────────────────────────────────────
export default function UserDashboard({ user, onLogout }) {
    ...
    return (
        <div style={{ padding: 20, fontFamily: "'Segoe UI', sans-serif", background: '#0a0f1e', minHeight: '100vh', color: 'white' }}>
            ...
            {/* ── TRAFFIC ANALYTICS (Updated for Ultrasonic) ── */}
            ...
            <div style={{ textAlign: 'center', marginTop: 28, color: '#1e3a5f', fontSize: 11 }}>
                HYDRA v8.0 — Ultrasonic Detection — User Dashboard — Nawinna Junction, Kurunegala
            </div>
        </div>
    );
}