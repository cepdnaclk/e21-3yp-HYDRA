// // client/src/App.js — HYDRA Dashboard v7.0 — Piezo Persistence Fix
// // PIEZO CHANGES:
...
export default function App() {
  ...
  // Listen for Firebase Google auth (for users)
  useEffect(() => {
  ...
  if (!authReady) {
    return (
      <div style={{
        ...
        color: '#475569', fontFamily: 'Segoe UI'
      }}>
        Loading...
      </div>
    );
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Admin route - Email/Password Login */}
        <Route path="/admin" element={
          admin
            ? <AdminDashboard user={admin} onLogout={handleAdminLogout} />
