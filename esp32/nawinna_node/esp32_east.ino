...
//   East road leads to → Puwakgashandiya Junction, Kurunegala
//
...
void mqttCallback(char* topic, byte* payload, unsigned int length){
    ...
    if(String(topic)==String(SUB_RAIN_ALL)){
        ...
        if(!deserializeJson(d,msg)){
            ...
            if(nr!=rainDetected){ rainDetected=nr; Serial.printf("🌧️ Rain update: %s\n",rainDetected?"RAIN":"DRY"); }
        }
        return;
    }
    ...
    if(pedCrossing){Serial.println("⚠️  Ped crossing — ignoring cmd");return;}
...
void setup(){
    ...
    Serial.println("\n╔══════════════════════════════════════════════╗");
    Serial.println("║  HYDRA — EAST ROAD NODE                      ║");
    Serial.println("║  Nawinna Junction, Kurunegala                ║");
    Serial.println("║  Next intersection: Puwakgashandiya Junction ║");
    Serial.println("╚══════════════════════════════════════════════╝");
...
// ── LOOP ──────────────────────────────────────────────────────────────────────
void loop(){
    if(WiFi.status()!=WL_CONNECTED){Serial.println("📶 Reconnecting WiFi...");connectWiFi();}
